    ...
    <div className="flex justify-center items-center min-h-screen mx-auto w-sm lg:w-md xl:w-2xl 3xl:w-2xl">
      ...
      >
        ...
        <div className="flex flex-col items-center mt-4">
          <button
            type="submit"
            className="rounded-full w-[50%] h-8 bg-green-600 text-white cursor-pointer disabled:opacity-50"
            disabled={isPending}
          >
          ...
          {mode === "login" ? (
            <Link href="/?mode=signup" className="mt-3 text-center">
              Dont have an account?! Click here for REGISTER.
            </Link>
          ) : (
            <Link href="/?mode=login" className="mt-3 text-center">
